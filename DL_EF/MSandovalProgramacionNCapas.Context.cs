...
namespace DL_EF
{
    ...
    public partial class MSandovalProgramacionNcapasEntities : DbContext
    {
        public MSandovalProgramacionNcapasEntities()
            : base("name=MSandovalProgramacionNcapasEntities")
        {
        }
        ...
        public virtual ObjectResult<ColoniaGetByIdIdMunicipio_Result> ColoniaGetByIdIdMunicipio(Nullable<int> idMunicipio)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ColoniaGetByIdIdMunicipio_Result>("ColoniaGetByIdIdMunicipio", idMunicipioParameter);
        }
        ...
        public virtual int UsuarioAdd(string nombre, string apellidoPaterno, string apellidoMaterno, string telefono, string celular, string sexo, Nullable<int> idRol, string userName, string email, string password, Nullable<System.DateTime> fechaNacimiento, string cURP, string calle, string numeroInterior, string numeroExterior, Nullable<int> idColonia, string imagen, ObjectParameter filasAfectadas)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UsuarioAdd", nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, telefonoParameter, celularParameter, sexoParameter, idRolParameter, userNameParameter, emailParameter, passwordParameter, fechaNacimientoParameter, cURPParameter, calleParameter, numeroInteriorParameter, numeroExteriorParameter, idColoniaParameter, imagenParameter, filasAfectadas);
        }
        ...
        public virtual int UsuarioUpdate(Nullable<int> idUsuario, string nombre, string apellidoPaterno, string apellidoMaterno, string telefono, string celular, string sexo, Nullable<int> idRol, string userName, string email, string password, Nullable<System.DateTime> fechaNacimiento, string cURP, string calle, string numeroInterior, string numeroExterior, string imagen, ObjectParameter filasAfectadas)
        {
            var idUsuarioParameter = idUsuario.HasValue ?
                new ObjectParameter("IdUsuario", idUsuario) :
                new ObjectParameter("IdUsuario", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UsuarioUpdate", idUsuarioParameter, nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, telefonoParameter, celularParameter, sexoParameter, idRolParameter, userNameParameter, emailParameter, passwordParameter, fechaNacimientoParameter, cURPParameter, calleParameter, numeroInteriorParameter, numeroExteriorParameter, imagenParameter, filasAfectadas);
        }
